...
<p style="padding: 10px 0px; font-size: 14px; line-height: 1.2; font-weight: 200; font-family: 'Roboto';">You can contact them best by {{ $content->contact_form }} at {{ $content->contact_form == 'Phone' ? $content->phone_num : $user->email }}.</p>
